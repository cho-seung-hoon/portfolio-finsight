...
<template>
    <header>
        <button @click="goToMain"><</button>
        <h1>나의 포트폴리오</h1>
    </header><hr>
    <body>
        <h2><span class="aggressive-highligher">적극투자형</span>을 위한 모델 포트폴리오</h2><br>
        <div>
            <h3>나의 투자 유형은?</h3>
            <p>여기에 그래프를 다시 로드해요.</p>
        </div><br>
        <div>
            <h3>Fin-sight 추천 자산비중</h3>
            <table>
                    <thead>
                        <tr>
                            <th class="table-style" colspan="2">상품별 종목</th>
                            <th class="table-style">위험등급</th>
                            <th class="aggressive-table-highligher">적극투자형</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="aggressive-table-highligher">10%</td>
                        </tr>
                        <tr>
                            <td class="table-style">국내 채권 혼합형 펀드/ETF</td>
                            <td class="table-style">5등급</td>
                            <td class="aggressive-table-highligher"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="aggressive-table-highligher">23%</td>
                        </tr>
                        <tr>
                            <td class="table-style">현금성(예금 등)</td>
                            <td class="table-style">6등급</td>
                            <td class="aggressive-table-highligher">2%</td>
                        </tr>
                        <tr>
                            <td class="table-style" rowspan="4">국내상품</td>
                            <td class="table-style">해외 주식형 펀드/ETF</td>
                            <td class="table-style">1등급</td>
                            <td class="aggressive-table-highligher">4%</td>
                        </tr>
                        <tr>
                            <td class="table-style">해외 주식형 펀드/ETF</td>
                            <td class="table-style">2등급</td>
                            <td class="aggressive-table-highligher">32%</td>
                        </tr>
                        <tr>
                            <td class="table-style">해외 주식형 펀드/ETF</td>
                            <td class="table-style">3등급</td>
                            <td class="aggressive-table-highligher">14%</td>
                        </tr>
                        <tr>
                            <td class="table-style">해외 채권형 펀드/ETF</td>
                            <td class="table-style">4등급</td>
                            <td class="aggressive-table-highligher">5%</td>
                        </tr>
                        <tr>
                            <td class="table-style" colspan="3">위험자산<small class="notice">**</small> 비중</td>
                            <td class="aggressive-table-highligher">60%</td>
                        </tr>
                        <tr>
                            <td class="table-style" colspan="3">모델 포트폴리오 위험도</td>
                            <td class="aggressive-table-highligher">3.50</td>
                        </tr>
                    </tbody>
                </table>
        </div><br>
