...
<template>
    ...
    <body>
        <h2><span class="neutral-highligher">위험중립형</span>을 위한 모델 포트폴리오</h2><br>
        <div>
            <h3>나의 투자 유형은?</h3>
            ...
            <table>
                    <thead>
                        <tr>
                            ...
                            <th class="neutral-table-highligher">위험중립형</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="neutral-table-highligher">8%</td>
                        </tr>
                        <tr>
                            <td class="table-style">국내 채권 혼합형 펀드/ETF</td>
                            <td class="table-style">5등급</td>
                            <td class="neutral-table-highligher">10%</td>
                        </tr>
                        <tr>
                            <td class="table-style">국내 채권형 펀드/ETF</td>
                            <td class="table-style">5등급</td>
                            <td class="neutral-table-highligher">6%</td>
                        </tr>
                        <tr>
                            <td class="table-style">국내 채권형 펀드/ETF</td>
                            <td class="table-style">6등급</td>
                            <td class="neutral-table-highligher">34%</td>
                        </tr>
                        <tr>
                            <td class="table-style">현금성(예금 등)</td>
                            <td class="table-style">6등급</td>
                            <td class="neutral-table-highligher">2%</td>
                        </tr>
                        <tr>
                            <td class="table-style" rowspan="4">국내상품</td>
                            <td class="table-style">해외 주식형 펀드/ETF</td>
                            <td class="table-style">1등급</td>
                            <td class="neutral-table-highligher"></td>
                        </tr>
                        <tr>
                            <td class="table-style">해외 주식형 펀드/ETF</td>
                            <td class="table-style">2등급</td>
                            <td class="neutral-table-highligher">28%</td>
                        </tr>
                        <tr>
                            <td class="table-style">해외 주식형 펀드/ETF</td>
                            <td class="table-style">3등급</td>
                            <td class="neutral-table-highligher">12%</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="neutral-table-highligher">48%</td>
                        </tr>
                        <tr>
                            <td class="table-style" colspan="3">모델 포트폴리오 위험도</td>
                            <td class="neutral-table-highligher">4.04</td>
                        </tr>
                    </tbody>
                </table>
        </div><br>
