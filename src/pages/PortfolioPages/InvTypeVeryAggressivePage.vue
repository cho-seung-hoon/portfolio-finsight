...
<section class="sub-title">
    <div class="result-section">
        <h2>
            <span class="highlight-veryaggressive">공격투자형</span>
...
<section class="sub-section">
    <div class="result-section">
        <h2>나의 투자유형은?</h2><br>
        <img src="/src/assets/styles/img/veryaggressiveChart.PNG" 
        alt="veryaggressiveChart" class="chart-image">
    </div>
</section>
<!-- GrapthSection end -->
<!-- TableSection start -->
