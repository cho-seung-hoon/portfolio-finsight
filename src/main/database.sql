...
where EAA.product_code = '292190';

select *
from Deposit d
         left join D_option o on o.product_code = d.product_code
where o.d_option_save_trm = 12
order by o.d_option_intr_rate desc;
...
WHERE Fund.fund_country = 'domestic' and Fund.fund_type = 'equity' and Fund.product_risk_grade = 1;

select *
from Etf
    left join E_Asset_Allocation EAA on Etf.product_code = EAA.product_code
    left join E_Equity_Ratio EER on Etf.product_code = EER.product_code
    left join E_Constituent_Stocks on Etf.product_code = E_Constituent_Stocks.product_code
where Etf.etf_country = 'domestic' and Etf.etf_type = 'equity' and Etf.product_risk_grade = 1;