...
public interface HoldingsMapper {
    HoldingsVO findByUserAndProduct(@Param("userId") String userId, @Param("productCode") String productCode);
    void insert(HoldingsVO holdings);
    void update(HoldingsVO holdings);
