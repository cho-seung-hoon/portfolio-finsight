...
export async function getDeposits(sort, isMatched) {
  try {
...
export async function getFunds(sort, country, type, isMatched) {
  try {
...
export async function getEtfs(sort, country, type, isMatched) {
  try {
